...
import processor.utils.MultiplyMatricesHandler;
import processor.utils.Size;

import java.util.List;

public class MultiplyMatricesController {
    public static void run() {
        ...
        List<List<Double>> result = MultiplyMatricesHandler.multiply(matrix1, matrix2);
        if (result == null) {
            System.out.println("The operation cannot be performed.");
            return;
        }
